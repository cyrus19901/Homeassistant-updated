...
"""
    ...
    Shows communication between CTA-2045 module and a broker for A.O. Smith Water heater
...
DEFAULT_NAME = 'A.O. Smith Water Heater CTA2045 Module'
...
class AOSMITHClimate(ClimateDevice):
    """Representation of a CTA- 2045 module for A.O Smith Water heater"""
    ...
    def __init__(self, hass, device_name, qos, retain, topic, mac_address):
        ...
        self.operation_mode_list_1 = [STATE_IDLE_NORMAL, STATE_RUNNING_NORMAL, STATE_RUNNING_CURTAILED_GRID, STATE_RUNNING_HEIGTENED_GRID, STATE_IDLE_GRID,
                                    STATE_SGD_ERROR_CONDITION, STATE_UNUSED]
        
        self.swing_mode_list_1 = [STATE_SHED, STATE_END_SHED,STATE_CRITICAL_PEAK_EVENT, STATE_GRID_EMERGENCY,
    ...
    def operation_list(self):
        ...
        return self.operation_mode_list_1
