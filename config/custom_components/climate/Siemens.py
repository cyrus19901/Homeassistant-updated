...
"""
    ...
    Shows communication between CTA-2045 module and a broker for Siemens Electrical Vehicle Charger
...
DEFAULT_NAME = 'Siemens Electrical Charger CTA2045 Module'
...
class SiemensClimate(ClimateDevice):
